 ...
 * 
 */
public class P2PVertexSizeFunction implements Transformer<TrustVertex,Integer>{
	...
	@Override
	public Integer transform(TrustVertex vertexID) {
		
		if (vertexID instanceof TrustVertex) {
