 ...
 * A "transformer" that maps vertices to colors.
	 ...
	 * @param <V>
	 */
	public class P2PVertexFillPaintTransformer extends PickableVertexPaintTransformer<TrustVertex> implements Transformer<TrustVertex,Paint>
	{
		...
		private Color docColor = DEF_DOC_COLOR;		
		    ...
		    public P2PVertexFillPaintTransformer(PickedInfo<TrustVertex> pi)
		    {
		    	super(pi, DEF_PEER_COLOR, DEF_PICKED_PEER_COLOR);
		    }
		    public P2PVertexFillPaintTransformer(PickedInfo<TrustVertex> pi, Color peerColor, Color pickedPeerColor,
		    ...
		    public Paint transform(TrustVertex v)
		    {
		    	//is it a peer
